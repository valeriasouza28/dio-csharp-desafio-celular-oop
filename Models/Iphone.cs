namespace DesafioPOO.Models
{
    ...
    public class Iphone : Smartphone
    {
        ...
        public Iphone(string numero, string marca, string modelo, string cor) : base(numero, marca, modelo, cor)
        {
        ...
        public override void InstalarAplicativo(string nomeApp)
        {
            try
            {
                ...
                Console.WriteLine($"\nO app {nomeApp} foi instalado com sucesso no Iphone.");
            }
            catch (Exception ex)
            {
        ...
        public override void DesinstalarAplicativo(string nomeApp)
        {
            try
            {
                ...
                Console.WriteLine($"Desinstalando {nomeApp} no Iphone...");
                Aplicativos.Remove(nomeApp.ToLower());
                Console.WriteLine($"\nO app {nomeApp} foi desinstalado com sucesso no Iphone.");
            }
            catch (Exception ex)
            {
